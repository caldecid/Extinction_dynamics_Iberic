...
p_value <- sum(abs(ull_auc) >= abs(observed_auc)) / length(null_auc)
...
subset_columns <- c("step", paste0("Sim", sample(1:99, 25))) 
...
# Plot the PD curves
png("text/Figures/Figure_Peninsula_PD.png", 
    width = 17, height = 15,
...
png("text/Figures/Figure_Peninsula_AUC.png", 
    width = 12, height = 10,
    units = "cm", pointsize = 8, res = 300)
...
# Plot the PD curves
png("text/Figures/Figure_andalucia_PD.png", 
    width = 17, height = 15,
    units = "cm", pointsize = 8, res = 300)
...
png("text/Figures/Figure_andalucia_AUC.png", 
    width = 12, height = 10,
    units = "cm", pointsize = 8, res = 300)
...
png("text/Figures/Figure_PD_curves.png", 
    width = 30, height = 15,
    units = "cm", pointsize = 8, res = 300)
