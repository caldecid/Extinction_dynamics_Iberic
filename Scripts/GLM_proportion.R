...
png("text/Figures/Supplementary/Figure_cor_pen_non.png", 
    width = 15, height = 15,
...
# Visualize the correlation matrix with a heatmap
png("text/Figures/Supplementary/Figure_cor_pen_low.png", 
    width = 15, height = 15,
    units = "cm", pointsize = 8, res = 300)
...
# Visualize the correlation matrix with a heatmap
png("text/Figures/Supplementary/Figure_cor_pen_int.png", 
    width = 15, height = 15,
    units = "cm", pointsize = 8, res = 300)
...
# Visualize the correlation matrix with a heatmap
png("text/Figures/Supplementary/Figure_cor_pen_high.png", 
    width = 15, height = 15,
    units = "cm", pointsize = 8, res = 300)
...
# Visualize the correlation matrix with a heatmap
png("text/Figures/Supplementary/Figure_cor_andalucia_non.png", 
    width = 15, height = 15,
    units = "cm", pointsize = 8, res = 300)
...
png("text/Figures/Supplementary/Figure_cor_andalucia_low.png", 
    width = 15, height = 15,
    units = "cm", pointsize = 8, res = 300)
...
# Visualize the correlation matrix with a heatmap
png("text/Figures/Supplementary/Figure_cor_andalucia_int.png", 
    width = 15, height = 15,
    units = "cm", pointsize = 8, res = 300)
...
# Visualize the correlation matrix with a heatmap
png("text/Figures/Supplementary/Figure_cor_andalucia_high.png", 
    width = 15, height = 15,
    units = "cm", pointsize = 8, res = 300)
